...
class NodeStats extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>uint64 participant_signal_failed = 55 [deprecated = true];</code>
     * @deprecated
     */
    protected $participant_signal_failed = 0;
    /**
     * Generated from protobuf field <code>uint64 participant_signal_validation_failed = 56 [deprecated = true];</code>
     * @deprecated
     */
    protected $participant_signal_validation_failed = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>uint64 participant_rtc_active = 54;</code>
     */
    protected $participant_rtc_active = 0;
    /**
     * forward metrics
     *
     ...
     *     @type int|string $participant_signal_failed
     *     @type int|string $participant_signal_validation_failed
     ...
     *     @type int|string $participant_rtc_active
    ...
    {
        if ($this->participant_signal_failed !== 0) {
            @trigger_error('participant_signal_failed is deprecated.', E_USER_DEPRECATED);
        }
    ...
    {
        if ($this->participant_signal_validation_failed !== 0) {
            @trigger_error('participant_signal_validation_failed is deprecated.', E_USER_DEPRECATED);
        }
