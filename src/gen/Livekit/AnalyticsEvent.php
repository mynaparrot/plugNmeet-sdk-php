...
class AnalyticsEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string id = 25;</code>
     */
    protected $id = '';
    /**
     ...
     */
    protected $sip_inbound_trunk = null;
    /**
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPCallInfo sip_call = 27;</code>
     * @return \Livekit\SIPCallInfo|null
     */
    public function getSipCall()
    {
        return $this->sip_call;
    }

    public function hasSipCall()
    {
        return isset($this->sip_call);
    }

    public function clearSipCall()
    {
        unset($this->sip_call);
    }
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPCallInfo sip_call = 27;</code>
     * @param \Livekit\SIPCallInfo $var
     * @return $this
     */
    public function setSipCall($var)
    {
        GPBUtil::checkMessage($var, \Livekit\SIPCallInfo::class);
        $this->sip_call = $var;
     ...
     */
    public function getSipInboundTrunk()
    {
        return $this->sip_inbound_trunk;
    }

    public function hasSipInboundTrunk()
    {
        return isset($this->sip_inbound_trunk);
    }

    public function clearSipInboundTrunk()
    {
        unset($this->sip_inbound_trunk);
    }
     ...
     * @return $this
     */
    public function setSipInboundTrunk($var)
    {
        GPBUtil::checkMessage($var, \Livekit\SIPInboundTrunkInfo::class);
        $this->sip_inbound_trunk = $var;
     ...
     */
    public function getSipOutboundTrunk()
    {
        return $this->sip_outbound_trunk;
    }

    public function hasSipOutboundTrunk()
    {
        return isset($this->sip_outbound_trunk);
    }

    public function clearSipOutboundTrunk()
    {
        unset($this->sip_outbound_trunk);
    }
     ...
     * @return $this
     */
    public function setSipOutboundTrunk($var)
    {
        GPBUtil::checkMessage($var, \Livekit\SIPOutboundTrunkInfo::class);
        $this->sip_outbound_trunk = $var;
     ...
     */
    public function getSipDispatchRule()
    {
        return $this->sip_dispatch_rule;
    }

    public function hasSipDispatchRule()
    {
        return isset($this->sip_dispatch_rule);
    }

    public function clearSipDispatchRule()
    {
        unset($this->sip_dispatch_rule);
    }
     ...
     * @return $this
     */
    public function setSipDispatchRule($var)
    {
        GPBUtil::checkMessage($var, \Livekit\SIPDispatchRuleInfo::class);
        $this->sip_dispatch_rule = $var;
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPTransferInfo sip_transfer = 36;</code>
     * @return \Livekit\SIPTransferInfo|null
     */
    public function getSipTransfer()
    {
        return $this->sip_transfer;
    }

    public function hasSipTransfer()
    {
        return isset($this->sip_transfer);
    }

    public function clearSipTransfer()
    {
        unset($this->sip_transfer);
    }

    /**
     * Generated from protobuf field <code>.livekit.SIPTransferInfo sip_transfer = 36;</code>
     * @param \Livekit\SIPTransferInfo $var
     * @return $this
     */
    public function setSipTransfer($var)
    {
        GPBUtil::checkMessage($var, \Livekit\SIPTransferInfo::class);
        $this->sip_transfer = $var;
    ...
    /**
     * Generated from protobuf field <code>.livekit.ReportInfo report = 33;</code>
     * @return \Livekit\ReportInfo|null
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.ReportInfo report = 33;</code>
     * @param \Livekit\ReportInfo $var
     * @return $this
     */
    public function setReport($var)
    {
        GPBUtil::checkMessage($var, \Livekit\ReportInfo::class);
        $this->report = $var;
    ...
    /**
     * Generated from protobuf field <code>.livekit.APICallInfo api_call = 34;</code>
     * @return \Livekit\APICallInfo|null
     */
    ...
    public function hasApiCall()
    {
        return isset($this->api_call);
    }

    public function clearApiCall()
    {
        unset($this->api_call);
    }
    ...
    /**
     * Generated from protobuf field <code>.livekit.APICallInfo api_call = 34;</code>
     * @param \Livekit\APICallInfo $var
     * @return $this
     */
    public function setApiCall($var)
    {
        GPBUtil::checkMessage($var, \Livekit\APICallInfo::class);
        $this->api_call = $var;
    ...
    /**
     * Generated from protobuf field <code>.livekit.WebhookInfo webhook = 35;</code>
     * @return \Livekit\WebhookInfo|null
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.WebhookInfo webhook = 35;</code>
     * @param \Livekit\WebhookInfo $var
     * @return $this
     */
    public function setWebhook($var)
    {
        GPBUtil::checkMessage($var, \Livekit\WebhookInfo::class);
        $this->webhook = $var;
