...
class RecordingInfoRes extends \Google\Protobuf\Internal\Message
{
    ...
    protected $msg = '';
    /**
     * Generated from protobuf field <code>.plugnmeet.RecordingInfo recording_info = 3;</code>
     */
    protected $recording_info = null;
    /**
     * Generated from protobuf field <code>.plugnmeet.PastRoomInfo room_info = 4;</code>
     */
    ...
    {
        GPBUtil::checkMessage($var, \Mynaparrot\PlugnmeetProto\RecordingInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Mynaparrot\PlugnmeetProto\PastRoomInfo::class);
        $this->room_info = $var;
